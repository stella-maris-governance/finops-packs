...
| # | What It Shows |
|---|--------------|
| 01 | Cost Management view grouped by cost center |
| 02 | Showback report: per-team monthly breakdown |
| 03 | Shared cost distribution calculation |
| 04 | Untagged cost quarantine report |
| 05 | Budget vs actual variance analysis |
